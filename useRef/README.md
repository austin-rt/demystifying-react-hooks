...
We have `initialFormValues`, an object with a blank email and password, which we use to initialize
...
Let’s create a new function called `scrollToElement` that expects a `ref` as a parameter and scrolls
us to said `ref`.
